...
def recommend(movie_name):
    movie_index = final[final["title_x"] == movie_name].index[0]
    ...
    for i in similar_movie:
        ...
        id = final.iloc[i[0]].id
        recommended_movie_posters.append(fetch_poster(id))
        recommended_movie_names.append(final.iloc[i[0]].title_x)
...
movie_list = final.title_x.values
